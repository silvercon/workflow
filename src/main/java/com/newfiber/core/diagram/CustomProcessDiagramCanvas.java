...
public class CustomProcessDiagramCanvas extends DefaultProcessDiagramCanvas {
	...
	public BufferedImage generateBufferedImage(String imageType) {
		...
		minX = (minX <= ActivitiWorkflowConstants.PROCESS_PADDING) ? ActivitiWorkflowConstants.PROCESS_PADDING : minX;
		minY = (minY <= ActivitiWorkflowConstants.PROCESS_PADDING) ? ActivitiWorkflowConstants.PROCESS_PADDING : minY;
		BufferedImage imageToSerialize = processDiagram;
		if (minX >= 0 && minY >= 0) {
			imageToSerialize = processDiagram.getSubimage(
				minX - ActivitiWorkflowConstants.PROCESS_PADDING,
				minY - ActivitiWorkflowConstants.PROCESS_PADDING,
				canvasWidth - minX + ActivitiWorkflowConstants.PROCESS_PADDING,
				canvasHeight - minY + ActivitiWorkflowConstants.PROCESS_PADDING);
		}
